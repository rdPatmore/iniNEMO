...
#        return da
    ...
    def calc_spectrum(self, proc='multi_taper', get_transects_flag=False):
        ...
        ds = xr.Dataset(data_vars=dict(
                        ...
                        temp_spec_gmean=(['sample','freq'], gmean_Pset),
