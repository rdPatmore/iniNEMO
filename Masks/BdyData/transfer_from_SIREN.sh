ARCH_PATH='/work/n02/n02/ryapat30/nemo/nemo/tools/SIREN/SOCHIC_12'

for pt in {T,U,V,I}; do
  for bound in {east,west,north,south}; do
    scp archer2:${ARCH_PATH}/bdy_${pt}_${bound}_y2015m11d04.nc \
    bdy_${pt}_${bound}_y2015m11.nc
  done
done
